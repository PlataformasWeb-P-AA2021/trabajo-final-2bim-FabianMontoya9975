...
public class Ejecutor {
    ...
    public static void ingresarPlanPostPagoMinutos(Persona prop, String ciudad,
        ...
        System.out.println("Ingresar el costo por minutos internacionales: ");
    ...
    public static void ingresarPlanPostPagoMinutosMegas(Persona prop,
        ...
        int gigas;
        double costoGigas;
        System.out.println("Ingresar el numero de minutos: ");
        minutos = sc.nextInt();
        System.out.println("Ingresar el costo por minuto: ");
        costoMinutos = sc.nextDouble();
        System.out.println("Ingresar el numero de gigas: ");
        gigas = sc.nextInt();
        System.out.println("Ingresar el costo por gigas: ");
